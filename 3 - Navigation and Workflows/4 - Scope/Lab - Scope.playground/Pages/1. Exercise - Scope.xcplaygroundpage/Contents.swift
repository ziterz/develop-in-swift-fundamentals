...
// it's because the foo constant is defined on for-loop scope, so it's a local constant
...
// this code will run well, because the "x" variable is global variable and it was change by for-loop before
...
greeting(greeting: "Hello", name: "Sera")
greeting(greeting: nil, name: "Sera")
