...
func eat(_ eatingTime: String) -> Meal? {
  return meals[eatingTime]
}
 ...
 */
func mealLog(_ meals: [String: Meal]) -> [String: Any] {
  if let checkLog = UserDefaults.standard.dictionary(forKey: "mealLog") {
    return checkLog
  } else {
    return [String: Any]()
  }
