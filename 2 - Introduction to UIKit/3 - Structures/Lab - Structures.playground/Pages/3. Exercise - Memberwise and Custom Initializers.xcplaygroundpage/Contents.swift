...
let favoriteBook = Book(title: "SwiftPro", author: "Paul Hudson", pages: 100)
print("My favorite book is \(favoriteBook.title), the author is \(favoriteBook.author), it have \(favoriteBook.pages) pages")
...
let macBook = Laptop(screenSize: 14, repairCount: 1, yearPurchased: 2023)
let hp = Laptop(repairCount: 10, yearPurchased: 2022)
/*:
...
let myHeight = Height(heightInCentimeters: 165.1)
