 ...
 */
let challenge1 = [String](["Walking challenges", "Running challenge", "Workout"])
let challenge2 = [String](["Walking challenges", "Running challenge", "Calisthenics challenge"])
...
var challenges = [challenge1] + [challenge2]
print(challenges)
...
if newChallenge.isEmpty {
  ...
  print("The challenge you have chosen is \(newChallenge[0])")
} else {
